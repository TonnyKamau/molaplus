...
export default function Home() {
  return (
    <main className="new-home">
      ...
      <section className="cta-v2"><p className="kicker kicker--light"><span /> Ready to grow?</p><h2>Let’s build a<br /><em>healthier farm.</em></h2><div><a className="button button--light" href="https://wa.me/254724968847" rel="noopener noreferrer" target="_blank">Order on WhatsApp <span>↗</span></a><a className="button button--line" href="tel:+254724968847">Call +254 724 968 847</a></div><small>Lipa na M-Pesa · Till number 906520</small></section>
    </main>
  );
}
